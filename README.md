<h1 align="center" style="margin-top: -4px !important;">Todo List in CLI</h1>

[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://github.com/dhvakr/Todo-Applicaion-in-CLI/blob/main/LICENSE)
![Build Paaasing](https://img.shields.io/badge/build-passing-brightgreen")
...
1. Install Node.js: You need to have npm installed in your computer for this program. It comes with Node.js and you can get it by installing Node from https://nodejs.org/en/
...
If you feel like some steps are missing out, feel free to make a pull request. [Github Repo](https://github.com/dhvakr/Todo-Applicaion-in-CLI/pulls)
